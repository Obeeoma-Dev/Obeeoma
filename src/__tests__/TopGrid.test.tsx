...
jest.mock('lucide-react', () => ({
  ...
  UserRoundPlus: jest.fn(() => <div data-testid="userroundplus-icon">UserRoundPlus</div>),
  ClipboardCheck: jest.fn(() => <div data-testid="clipboardcheck-icon">ClipboardCheck</div>),
  HelpCircle: jest.fn(() => <div data-testid="helpcircle-icon">HelpCircle</div>),
}));
