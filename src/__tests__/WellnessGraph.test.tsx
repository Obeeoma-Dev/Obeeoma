...
describe("WellnessGraph", () => {
  const mockData = [
    {
      date: "2023-01-01",
      avg_score: 4.2,
      mood_counts: { Great: 10, Good: 5, Neutral: 0, Bad: 0, Terrible: 0 },
    },
    {
      date: "2023-01-02",
      avg_score: 3.8,
      mood_counts: { Great: 0, Good: 8, Neutral: 2, Bad: 0, Terrible: 0 },
    },
    {
      date: "2023-01-03",
      avg_score: 4.5,
      mood_counts: { Great: 12, Good: 3, Neutral: 0, Bad: 0, Terrible: 0 },
    },
  ];
  ...
  it("renders the wellness graph with data", () => {
    ...
    expect(
      screen.getByText("Daily mood average based on surveys"),
    ).toBeInTheDocument();
  });
  ...
  it("renders with empty data", () => {
    ...
    expect(
      screen.getByText("No mood data available for this period"),
    ).toBeInTheDocument();
  });
