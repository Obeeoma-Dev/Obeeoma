...
const Services = () => {
    ...
    return (_jsx("section", { className: "py-24 bg-muted/30", children: _jsxs("div", { className: "container mx-auto px-6", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h2", { className: "text-4xl font-bold mb-4", children: "Comprehensive Mental Health Care" }), _jsx("p", { className: "text-xl text-muted-foreground max-w-2xl mx-auto", children: "Our platform offers a range of services designed to support your mental health journey" })] }), _jsx("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: _jsxs("div", { className: "relative lg:pl-12", children: [_jsx("div", { className: "absolute inset-0 bg-primary/5 rounded-3xl -z-10 transform translate-x-8 translate-y-8" }), _jsx("img", { src: image3, alt: "Professional working", className: "rounded-3xl shadow-2xl w-full object-cover" })] }) }), _jsx("div", { className: "grid sm:grid-cols-2 gap-6", children: services.map((service, index) => (_jsx(Card, { className: "hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20", children: _jsxs(CardContent, { className: "p-6", children: [_jsx("div", { className: "w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4", children: _jsx(service.icon, { className: "w-6 h-6 text-primary" }) }), _jsx("h3", { className: "text-lg font-semibold mb-2", children: service.title }), _jsx("p", { className: "text-sm text-muted-foreground", children: service.description })] }) }, index))) })] }) }));
};
