...
const Benefits = () => {
    ...
    return (_jsx("section", { 
        ...
        style: { marginBottom: 0, fontFamily: 'heading' }, children: _jsxs("div", { className: "container", children: [_jsxs("div", { className: "text-center mb-5", children: [_jsx("h2", { className: "display-6 fw-bold mb-3", style: { fontFamily: "heading" }, children: "Comprehensive Obeeoma Features" }), _jsx("p", { className: "text-muted lead mb-5", children: "Everything your organization needs to build a mentally healthy workplace" })] }), _jsx("div", { className: "row g-4", children: benefits.map((benefit, index) => {
