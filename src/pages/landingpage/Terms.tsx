            ...
            <main className="flex-grow-1 bg-gradient-custom py-5">
                <Container className="py-5">
                    ...
                    >
                        ...
                        <p className="text-emerald fw-medium mb-2">Effective Date: November 2025</p>
                        <p className="text-gray mb-0 mx-auto hero-text">
                            Welcome to <span className="text-emerald fw-medium">Obeeoma</span> ("we," "our," or "us").
                            These Terms and Conditions ("Terms") govern your access to and use of the Obeeoma mobile
                            app, website, and all related services (collectively, the "Platform"). By accessing or
                            using Obeeoma, you agree to comply with and be bound by these Terms. If you do not agree,
                                    ...
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray mb-2">
                                                Obeeoma is a virtual mental health platform that connects users with qualified
                                                therapists and provides AI-powered and community-based mental health support.
                                                The platform offers:
                                            </p>
                                            <ul className="text-gray small mb-2">
                                                <li><span className="text-emerald me-2">•</span>Access to professional therapy sessions</li>
                                                <li><span className="text-emerald me-2">•</span>AI-powered mental health chat support</li>
                                                <li><span className="text-emerald me-2">•</span>Educational and mindfulness content</li>
                                                <li><span className="text-emerald me-2">•</span>Peer support communities</li>
                                            </ul>
                                            <p className="text-gray small fw-medium">
                                                Obeeoma is not an emergency or crisis service. If you are in crisis or may be at
                                                risk of harming yourself, please contact local emergency services immediately.
                                            </p>
                                        </div>
                                    </Stack>
                                </Card>
                                ...
                                <Card className="h-100 shadow-sm border-custom p-3">
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray mb-2">To use Obeeoma, you must:</p>
                                            <ul className="text-gray small mb-2">
                                                <li><span className="text-blue me-2">•</span>Be at least 18 years old</li>
                                                <li><span className="text-blue me-2">•</span>Provide accurate and truthful information</li>
                                                <li><span className="text-blue me-2">•</span>Use the Platform for lawful purposes only</li>
                                            </ul>
                                            <p className="text-gray small">Therapists on the platform must be licensed or certified to practice in their respective jurisdictions.</p>
                                        </div>
                                    </Stack>
                                </Card>
                            </motion.div>
                            ...
                            <motion.div variants={cardVariants}>
                                <Card className="h-100 shadow-sm border-custom p-3">
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            <h2 className="h5 fw-bold mb-3">3. Account Registration</h2>
                                            <p className="text-gray mb-2">You must create an account to access most Obeeoma services. You agree to:</p>
                                            <ul className="text-gray small mb-2">
                                                <li><span className="text-purple me-2">•</span>Keep your login details secure</li>
                                                <li><span className="text-purple me-2">•</span>Provide accurate and current information</li>
                                                <li><span className="text-purple me-2">•</span>Notify Obeeoma immediately of unauthorized use of your account</li>
                                            </ul>
                                            <p className="text-gray small">You are responsible for all activities that occur under your account.</p>
                                        </div>
                                    </Stack>
                                </Card>
                            </motion.div>
                                ...
                                <Card className="h-100 shadow-sm border-custom p-3">
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray mb-2">Some Obeeoma features require payment.</p>
                                            <ul className="text-gray small mb-0">
                                                <li><span className="text-green me-2">•</span>Payments are processed through secure third-party gateways (e.g., Paystack, Flutterwave)</li>
                                                <li><span className="text-green me-2">•</span>Obeeoma does not store your payment card details</li>
                                                <li><span className="text-green me-2">•</span>All charges are non-refundable unless stated otherwise</li>
                                                <li><span className="text-green me-2">•</span>You agree to pay all applicable fees when due</li>
                                            </ul>
                                        </div>
                                    </Stack>
                                </Card>
                                ...
                                <Card className="h-100 shadow-sm border-custom p-3">
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-gray small mb-2">
                                                <li><span className="text-indigo me-2">•</span>Post or share offensive, abusive, or unlawful content</li>
                                                <li><span className="text-indigo me-2">•</span>Share personal information belonging to others without consent</li>
                                                <li><span className="text-indigo me-2">•</span>Use the AI chat for diagnosis or crisis intervention</li>
                                            </ul>
                                            <p className="text-gray small mt-2">
                                                We may moderate or remove harmful content to ensure user safety.
                                            </p>
                                        </div>
                                    </Stack>
                                </Card>
                                    ...
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-gray small mb-0">
                                                ...
                                                <li><span className="text-red me-2">•</span>We are not responsible for actions or omissions of therapists or third parties</li>
                                                <li><span className="text-red me-2">•</span>Use of Obeeoma is at your sole risk</li>
                                            </ul>
                                        </div>
                                    </Stack>
                                </Card>
                                    ...
                                    <Stack direction="horizontal" gap={3}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray small">
                                                ...
                                                obligation to pay outstanding fees or respect confidentiality commitments.
                                            </p>
                                        </div>
                                    </Stack>
                                </Card>
                    ...
                    </motion.div> {/* End of Terms Cards Grid */}
                </Container>
            </main>
