    ...
    children: _jsxs("div", {
      ...
      children: [
        _jsx("h2", {
          ...
          children: "Comprehensive Obeeoma Features",
        }),
        _jsx("p", {
          ...
          children: features.map((f, i) =>
            _jsx(
              "div",
              {
                className: "col-md-4",
                children: _jsxs("div", {
                  className: "card card-feature h-100 p-4",
                  children: [
                    _jsx("div", {
                      className: "mb-3 text-primary",
                      children: _jsx(f.icon, { size: 36 }),
                    }),
                    _jsx("h5", { className: "fw-semibold", children: f.title }),
                    _jsx("p", { className: "text-muted", children: f.desc }),
                  ],
                }),
              },
              i,
