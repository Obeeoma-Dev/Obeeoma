...
const Features = () => {
    ...
    return (_jsx("section", { className: "section-bg py-5", children: _jsxs("div", { className: "container text-center", children: [_jsx("h2", { className: "fw-bold mb-3 text-green", children: "Comprehensive Obeeoma Features" }), _jsx("p", { className: "text-muted mb-5", children: "Explore tools designed to enhance mental health in your organization." }), _jsx("div", { className: "row g-4", children: features.map((f, i) => (_jsx("div", { className: "col-md-4", children: _jsxs("div", { className: "card card-feature h-100 p-4", children: [_jsx("div", { className: "mb-3 text-green", children: _jsx(f.icon, { size: 36, className: "text-primary" }) }), _jsx("h5", { className: "fw-semibold", children: f.title }), _jsx("p", { className: "text-muted", children: f.desc })] }) }, i))) })] }) }));
};
