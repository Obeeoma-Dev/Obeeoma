          ...
          >
            ...
            >
              ...
              <h2 className="display-5 mb-4" style={{ fontFamily: "heading" }}>
                Send us a feedback, or share an experience.
              </h2>
      ...
      <Container className="py-5">
        <Row className="g-0">
          <Col
            ...
            style={{
              background: "linear-gradient(to bottom right, #00A859, #0B6E45)",
              borderRadius: "1.5rem",
            }}
          >
            <h2
        ...
        <Container>
          <Row className="align-items-center justify-content-between">
            <Col xs="auto" className="d-flex gap-3">
              <a
                href="#"
                className="d-flex justify-content-center align-items-center rounded-circle bg-white bg-opacity-10 p-2"
                style={{ fontFamily: "body" }}
                aria-label="Facebook"
              >
            ...
            <Col xs="auto">
              <p className="mb-0 text-white-75" style={{ fontFamily: "body" }}>
                ...
                <span className="text-light">RHIPFactory</span>
              </p>
            </Col>
          </Row>
        </Container>
