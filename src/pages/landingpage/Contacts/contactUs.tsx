    ...
    return (
        <div className="d-flex flex-column min-vh-100">
            ...
            <Container className="py-5">
                <Row className="g-4">
                    {/* Left Column */}
                    <Col lg={6} className={`${isVisible ? 'opacity-100 translateX-0' : 'opacity-0 translateX-n3'} transition-opacity`}>
                        <Card className="text-white" style={{ background: 'linear-gradient(to bottom right, #00A859, #0B6E45)', borderRadius: '1.5rem', padding: '3rem' }}>
                            <p className="fs-5 opacity-75 mb-3" style={{ fontFamily: "body" }}>Looking to get in touch with us?</p>
                            <h2 className="display-5 mb-4" style={{ fontFamily: "heading" }}
                            >Send us a feedback, or share an experience.</h2>
