    ...
    const fetchBlogs = async () => {
      try {
        ...
        const mapped: Blog[] = data.map((item: BackendArticle) => ({
          ...
          fullContent:
            item.content ||
            "This is the full content of the blog post. In a real application, this would contain the complete article text with multiple paragraphs, detailed information, and comprehensive coverage of the topic.",
