                ...
                return (
                    <div className="text-center my-3">
                        ...
                        <p className="text-muted mb-4">
                            Your account has been registered and an email has been sent to your email. </p>
{/* 
...
//                     <div className="text-center my-3">
//                         <FontAwesomeIcon icon={faCheckCircle} size="3x" style={{ color: customStyles.primaryColor, marginBottom: '1rem' }} />
//                         <h4 className="fw-semibold text-dark">Account verified.</h4>
//                         <p className="text-muted mb-4">
//                             Your account is created and verification details have been sent via your organisation email</p>
