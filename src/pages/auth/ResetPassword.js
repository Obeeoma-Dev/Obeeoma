...
const ResetPassword = () => {
    ...
    _jsxs("div", { style: {
            ...
            position: "relative",
                    ...
                    fontSize: "0.8rem",
                    zIndex: 1000,
                }, children: ["\u00A9 2025 ", customStyles.logoText, ". All rights reserved. \u00A0", _jsx(Link, { className: "mx-3", style: { textDecoration: "none" }, role: "button", to: "/privacy-policy", children: "Privacy Policy" }), "\u00A0|\u00A0", _jsx("a", { href: "#", className: "text-muted", style: { textDecoration: "none" }, children: "Terms of Service" }), _jsx("span", { className: "mx-3", children: "|" }), _jsx("a", { href: "#", className: "text-muted", style: { textDecoration: "none" }, children: "Contact Us" })] })] }));
};
export default ResetPassword;
