...
export default function OtpVerificationPage() {
  ...
  const handleResendCode = useCallback(
    async (e: React.MouseEvent<HTMLAnchorElement>) => {
      ...
      if (!email) {
        setLocalError(
          "Email address is missing. Please return to the previous step.",
        );
        return;
      }
    ...
    [dispatch, email, isResendLoading, resendTimer],
    ...
    <div className="container d-flex justify-content-center align-items-center vh-100">
      ...
      >
        ...
        <h2
          ...
          style={{ fontFamily: "body", fontSize: "1.5rem", fontWeight: "bold" }}
        >
          Check Your Email
        </h2>
        <p
          className="text-muted mb-4"
          style={{ fontFamily: "body", fontSize: "0.9rem" }}
        >
        ...
        <div className="otpGroup" style={otpGroupStyle}>
          <OtpInput value={otp} valueLength={OTP_LENGTH} onChange={setOtp} />
        </div>
