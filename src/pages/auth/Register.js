...
const Register = () => {
    ...
    const getFinalValues = (values) => {
        ...
        const finalLocation = values.Location === "OTHER" ? values.otherLocation : values.Location;
    ...
    const handleNext = async (values, setTouched, setErrors, validateForm) => {
        ...
        currentStepFields.forEach((field) => {
            ...
            if (field === "otherLocation" && values.Location !== "OTHER")
                return;
            if (field === "otherContactPersonRole" &&
    ...
    return (_jsxs("div", { style: {
            ...
            fontFamily: "body",
                            ...
                            fontFamily: "body",
                        }, children: _jsxs(Card.Body, { style: { padding: "2.5rem" }, className: "d-flex flex-column col-12", children: [_jsx(Link, { to: "/", children: _jsx("div", { className: "d-flex flex-column align-items-center justify-content-center mb-3", style: { fontFamily: "heading" }, children: _jsx("img", { src: logo, alt: "Obeeoma Logo", style: {
                                                height: "50px",
                                                width: "auto",
