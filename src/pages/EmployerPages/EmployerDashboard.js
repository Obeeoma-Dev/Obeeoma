...
const EmployerDashboard = () => {
    ...
    return (_jsx(Layout, { title: "Organization Overview", children: _jsxs("div", { className: "container-fluid py-4 px-3", children: [_jsx(StatsGrid, { stats: statsData }), _jsx(ChartsSection, { chartData: chartData }), _jsx(RecentActivity, { activities: activities })] }) }));
};
