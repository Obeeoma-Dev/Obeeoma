...
const CompanyReports = () => {
    ...
    const additionalHeader = (_jsxs("div", { className: "d-flex gap-2", children: [_jsxs("button", { className: "btn btn-outline-secondary d-flex align-items-center gap-2", children: [_jsx(Filter, { size: 16 }), "Filter"] }), _jsxs("button", { className: "btn btn-outline-secondary d-flex align-items-center gap-2", children: [_jsx(Calendar, { size: 16 }), "Date Range"] }), _jsxs("button", { className: "btn btn-primary d-flex align-items-center gap-2", children: [_jsx(Download, { size: 16 }), "Export All"] })] }));
    return (_jsx(Layout, { title: "Company Reports", showSearch: true, additionalHeaderContent: additionalHeader, children: _jsxs("div", { className: "container-fluid py-4", children: [_jsx(ReportsHeader, {}), _jsx(WellnessTrends, {}), _jsx(DepartmentMetrics, {}), _jsx(AvailableReports, {}), _jsx(KeyMetrics, {})] }) }));
};
