...
const EmployeeManagement = () => {
    ...
    const additionalHeader = (_jsxs("button", { className: "btn btn-success d-flex align-items-center gap-2", children: [_jsx(Plus, { size: 16 }), "Add Employee"] }));
    return (_jsx(Layout, { title: "Employee Management", showSearch: true, additionalHeaderContent: additionalHeader, children: _jsx("div", { className: "row gy-4", children: _jsx("div", { className: "container-fluid py-4 px-3", children: _jsxs("div", { className: "col-lg-12 col-md-9 col-sm-6 mx-auto", children: [_jsx(EmployeeTable, { searchQuery: searchQuery, onSearchChange: setSearchQuery }), _jsx(AddEmployeeForm, {})] }) }) }) }));
};
