...
//       title: "General Company Mood",
//       value: getScoreFromMood(stats?.generalMood).toString(),
//       description: stats.generalMood || "Great", // 
//       icon: "TrendingUp",
//       color: PRIMARY_COLOR,
//     },
//     {
...
  };
  ...
  /**
   * Maps a string mood to an emoji for visual display in the description.
   */
  const getEmojiFromMood = (mood: string | undefined): string => {
    if (!mood) return '🙂';
...
  // component props (The data structure that feeds the TopGrid)
    const statsData = stats ? [
      // 1. Add Employee Card (Leftmost on the image)
    {
      title: "Add Employee",
      value: "",
      icon: "UserRoundPlus", 
...
    {
      title: "General Company Mood",
      // Pass the raw mood string as description/extra detail to potentially display the emoji
      value: getScoreFromMood(stats?.generalMood).toString(),
      // Passing the emoji as part of the description or value for visual display (if supported by TopGrid)
      description: getEmojiFromMood(stats.generalMood) || "🙂", 
      // Icon is the green checkmark/status indicator
      icon: "CheckCircle",
      color: PRIMARY_COLOR, // Green
    },
      // 4. Help & Support Card
...
      // Icon is the question mark icon
      icon: "HelpCircle", 
      color: SECONDARY_COLOR, // Grey/Secondary
    },
  ] : [];
