...
const ClientEngagement = () => {
    ...
    return (_jsx(SystemAdminLayout, { title: "Client Engagement", children: _jsx("div", { className: "flex-grow-1 overflow-auto", children: _jsxs(Container, { className: "py-4", children: [_jsx(EngagementSummary, { engagementRate: engagementRate }), _jsx(EngagementCharts, { weeklyEngagement: data?.weekly_engagement ?? [] }), _jsx(PatientSearchFilter, {}), _jsx(EngagementStatsPanel, { trends: trends, streaks: streaks })] }) }) }));
};
