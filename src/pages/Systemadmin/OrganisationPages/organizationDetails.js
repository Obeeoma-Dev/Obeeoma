            ...
            _jsxs(Container, {
              ...
              children: [
                  ...
                  children: _jsx(Card.Body, {
                    children: _jsxs(Row, {
                      children: [
                        ...
                        _jsxs(Col, {
                          children: [
                            _jsx("strong", { children: "Last Active:" }),
                            " ",
                            org.lastActive,
                          ],
                        }),
                ...
                _jsxs(Card, {
                  ...
                  children: [
                    _jsx(Card.Header, {
                      children: "Wellness Center Inc. Details",
                    }),
                    _jsxs(Card.Body, {
                      children: [
                        _jsxs(Row, {
                ...
                _jsxs(Card, {
                  className: "mb-4",
                  children: [
                    _jsx(Card.Header, { children: "Program Engagement (%)" }),
                    _jsx(Card.Body, {
                      children: _jsxs("ul", {
                        children: [
                          _jsxs("li", {
                ...
                _jsxs(Card, {
                  ...
                  children: [
                    _jsx(Card.Header, {
                      children: "Platform Usage & Distribution",
                    }),
                    _jsx(Card.Body, { children: _jsx(OrganizationCharts, {}) }),
                  ],
                }),
                _jsxs(Card, {
                  children: [
                    _jsx(Card.Header, { children: "Recent Activity" }),
                    _jsx(Card.Body, {
                      children: _jsx(ListGroup, {
                        variant: "flush",
                        children: org.activity.map((event, index) =>
