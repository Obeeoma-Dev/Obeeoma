...
const OrganizationDetails = () => {
    ...
    return (_jsxs("div", { className: "d-flex vh-100", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "flex-grow-1 d-flex flex-column overflow-hidden", children: [_jsx(Header, {}), _jsxs(Container, { fluid: true, className: "p-4 overflow-auto page-background", children: [_jsxs("div", { className: "d-flex justify-content-between align-items-center mb-4", children: [_jsx(Button, { variant: "outline-secondary", onClick: () => navigate('/system-admin/organizations'), children: "\u2190 Wellness Center Inc." }), _jsxs("div", { className: "d-flex gap-2", children: [_jsx(Button, { variant: "outline-success", size: "sm", children: "Manage Subscription" }), _jsx(Button, { variant: "outline-primary", size: "sm", children: "Save Changes" })] })] }), _jsxs(Card, { className: "p-4 shadow-sm", children: [_jsxs("h3", { className: "text-success fw-bold mb-4", children: ["Organization Overview: ", org.name] }), _jsxs(Row, { className: "gy-4 mb-4", children: [_jsx(Col, { md: 4, children: _jsxs(Card, { className: "shadow-sm h-100 border-0", children: [_jsx(Card.Header, { className: "fw-semibold text-white", style: { backgroundColor: "#00A859" }, children: "Organization Summary" }), _jsx(Card.Body, { children: _jsxs(Row, { className: "gy-3", children: [_jsx(Col, { xs: 12, children: _jsxs("div", { className: "d-flex align-items-center", children: [org.icon && org.icon.startsWith("http") && (_jsx("img", { src: org.icon, alt: `${org.name} logo`, style: {
                                                                                        width: "40px",
                                                                                        height: "40px",
                                                                                        objectFit: "cover",
                                                                                        borderRadius: "6px",
                                                                                        marginRight: "10px"
                                                                                    } })), _jsxs("div", { children: [_jsx("div", { className: "fw-semibold fs-6", children: org.name }), _jsxs("div", { className: "text-muted small", children: ["ID: ", org.id] })] })] }) }), _jsxs(Col, { xs: 12, children: [_jsx("strong", { children: "Subscription Plan:" }), " ", _jsx(Badge, { style: { backgroundColor: "#00A859", color: "#fff" }, children: org.subscription })] }), _jsxs(Col, { xs: 12, children: [_jsx("strong", { children: "Status:" }), _jsx("div", { className: "mt-1", children: _jsx(Badge, { style: {
                                                                                        backgroundColor: org.status === "Active" ? "#00A859" : "#6c757d",
                                                                                        color: "#fff"
                                                                                    }, children: org.status }) })] }), _jsx(Col, { xs: 12, children: _jsxs("div", { className: "d-flex flex-column", children: [_jsx("strong", { className: "mb-1", children: "Region:" }), _jsx(Badge, { bg: "secondary", style: { color: "#fff" }, children: org.region })] }) }), _jsx(Col, { xs: 12, children: _jsxs("div", { className: "d-flex flex-column", children: [_jsx("strong", { className: "mb-1", children: "Last Active:" }), _jsx("span", { style: { color: "#fff" }, children: org.lastActive })] }) })] }) })] }) }), _jsx(Col, { md: 4, children: _jsx(Card, { className: "shadow-sm h-100", children: _jsxs(Card.Body, { children: [_jsx("strong", { children: "Total Clients:" }), _jsx("h4", { className: "mt-2 text-primary", children: org.clients })] }) }) }), _jsx(Col, { md: 4, children: _jsx(Card, { className: "shadow-sm h-100", children: _jsxs(Card.Body, { children: [_jsx("strong", { children: "Active Programs:" }), _jsx("h4", { className: "mt-2 text-primary", children: org.programs })] }) }) })] }), _jsxs(Card, { className: "shadow-sm mb-4", children: [_jsx(Card.Header, { className: "fw-semibold", children: "Navigation Links" }), _jsx(Card.Body, { children: _jsx(ListGroup, { variant: "flush", children: (org.navigationLinks && org.navigationLinks.length > 0
                                                        ? org.navigationLinks
                                                        : [
                                                            'Organization Settings',
                                                            'User Management',
