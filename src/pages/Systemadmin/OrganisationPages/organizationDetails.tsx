                    ...
                    <div className="flex-grow-1">
                      <PlatformUsageChart
                        data={[
                          {
                            week: "Week 1",
                            usage: organization.client_count || 0,
                          },
                          {
                            week: "Week 2",
                            usage: Math.floor(
                              (organization.client_count || 0) * 0.8,
                            ),
                          },
                          {
                            week: "Week 3",
                            usage: Math.floor(
                              (organization.client_count || 0) * 0.9,
                            ),
                          },
                          {
                            week: "Week 4",
                            usage: Math.floor(
                              (organization.client_count || 0) * 1.1,
                            ),
                          },
                          {
                            week: "Week 5",
                            usage: Math.floor(
                              (organization.client_count || 0) * 1.2,
                            ),
                          },
                          {
                            week: "Week 6",
                            usage: Math.floor(
                              (organization.client_count || 0) * 1.0,
                            ),
                          },
                        ]}
                      />
