...
type AdminChatAction =
  ...
  | { type: 'ADD_MESSAGES'; payload: { userMessage: AdminChatMessage; aiResponse: AdminChatMessage } }
...
// Reducer
const adminChatReducer = (state: AdminChatState, action: AdminChatAction): AdminChatState => {
  switch (action.type) {
    case 'TOGGLE_CHAT':
