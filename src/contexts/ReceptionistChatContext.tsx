...
type ReceptionistChatAction =
  ...
  | { type: 'ADD_MESSAGES'; payload: { userMessage: ReceptionistChatMessage; aiResponse: ReceptionistChatMessage } }
...
// Reducer
const receptionistChatReducer = (state: ReceptionistChatState, action: ReceptionistChatAction): ReceptionistChatState => {
  switch (action.type) {
    case 'TOGGLE_CHAT':
...
const ReceptionistChatContext = createContext<ReceptionistChatContextType | undefined>(undefined);
...
export const ReceptionistChatProvider: React.FC<ReceptionistChatProviderProps> = ({ children }) => {
  ...
  return <ReceptionistChatContext.Provider value={value}>{children}</ReceptionistChatContext.Provider>;
};
...
export const useReceptionistChat = () => {
  ...
  if (context === undefined) {
    throw new Error('useReceptionistChat must be used within a ReceptionistChatProvider');
  }
  return context;
};
