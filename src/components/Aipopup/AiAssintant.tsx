            ...
            <Card className="ai-chat-card">
              ...
              <Card.Body className="ai-chat-body">
                {!isEnabled ? (
                  ...
                  >
                    AI Assistant is currently disabled. Please enable it from
                    the AI Management dashboard to use this feature.
                  </div>
                ) : (
                  <>
                    {error && (
                    ...
                    {messages.length === 0 && !isLoading ? (
                      ...
                      >
                        Hello! I'm your AI assistant for platform insights. Ask
                        me about resource consumption, platform growth, or
                        system optimization.
                      </div>
                    ) : (
