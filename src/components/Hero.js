...
const Hero = () => {
    ...
    return (_jsxs("section", { className: "hero-section d-flex align-items-center justify-content-center text-center text-white", style: {
            ...
            paddingBottom: "2rem",
                                                ...
                                                color: "rgba(77, 255, 77, 0.9)",
                                                transition: "background-color 0.3s ease, color 0.3s ease",
                                            }, onClick: () => navigate("/login"), children: "Sign In" })] })] }), _jsx(Col, { lg: 6, className: "text-center", children: _jsx("img", { src: heroImage, alt: "Obeeoma workplace support", className: "img-fluid rounded-4 shadow-lg d-lg-none" }) })] }) }), _jsx("div", { style: {
                    position: "absolute",
                    bottom: 0,
                    left: 0,
                    width: "100%",
                    height: "150px",
                    background: "linear-gradient(to bottom, rgba(0, 128, 0, 0.3) 0%, #f6fff8 100%)",
                    zIndex: 1,
                } })] }));
};
export default Hero;
