    ...
    return (_jsxs("section", { className: "hero-section d-flex align-items-center", style: {
            ...
            paddingBottom: "2rem",
                                        ...
                                        fontSize: "1.25rem",
                                                ...
                                                color: "rgba(77, 255, 77, 0.9)",
                                                transition: "background-color 0.3s ease, color 0.3s ease",
                                            }, onClick: () => navigate("/login"), children: "Sign In" })] })] }), _jsx(Col, { lg: 6, className: "text-center", children: heroImage && (_jsx("img", { src: heroImage, alt: "Obeeoma workplace support", className: "img-fluid rounded-4 shadow-lg d-lg-none" })) })] }) }), _jsx("div", { style: {
                    position: "absolute",
                    bottom: 0,
                    left: 0,
                    width: "100%",
