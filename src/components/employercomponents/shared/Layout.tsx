...
// const formatEmployerName = (employer: EmployerType | null | undefined): string => {
//     if (!employer) return "User";
//     // Check if both first and last name are null/undefined/empty
//     const name = `${employer.firstName || ''} ${employer.lastName || ''}`.trim();
...
//                             className="fw-medium text-dark d-block"
//                             style={{ fontFamily: 'body' }}
//                             aria-label={`Company name: ${employer?.organizationName || employer?.company?.name || "Company"}`}
//                         >
//                             {employer?.organizationName || employer?.company?.name || "Company"}
//                         </span>
