...
const RecentActivity = ({
  ...
  const recentActivity =
    activities?.length >= 7 ? activities : defaultActivities;
  ...
  return (
    <div className="card border-0 shadow-sm">
      <div className="card-body">
        ...
        >
          {" "}
          {/* FONT CHANGE 3: Apply body font to list */}
          {recentActivity.slice(0, maxItems).map((activity, index) => (
            <div
              key={index}
              className="list-group-item px-0 py-3 border-bottom-0"
            >
              <div className="d-flex align-items-start gap-3">
                <div
                  ...
                  }} // COLOR CHANGE 2: Activity dot color
                ></div>
