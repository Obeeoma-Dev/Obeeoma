// src/components/employercomponents/companyemployees/EmployeeTable.tsx

import React, { useState, useEffect } from "react";
import { Search } from "lucide-react";
import { useDispatch, useSelector } from "react-redux";
import { fetchEmployeeInvites, clearEmployerError} from '../../../store/slices/EmployerSlice';
import { Employee, EmployeeInvite } from "../../../types/employer"; 
import { AppDispatch, RootState } from "../../../store/store"; 
import { useToast } from "../../../hooks/use-toast";
import { selectEmployeeTableState, EmployeeTableState } from "../../../store/selectors/employerSelectors";
...
const EmployeeTable = ({ searchQuery, onSearchChange }: EmployeeTableProps) => {
  ...
  // FIX: Use the MEMOIZED selector with correct types
  const { invites, isLoading, isActionLoading, error } = useSelector<RootState, EmployeeTableState>(
  ...
  // Fetch employee invites ONCE on component mount
  useEffect(() => {
    // Dispatch the thunk to fetch the initial data
  ...
  // REFRESH INVITATION LIST AFTER SUCCESSFUL INVITE
...
// import { useToast } from "../../../hooks/use-toast";
// import { selectEmployeeTableState } from "../../../store/selectors/employerSelectors";
