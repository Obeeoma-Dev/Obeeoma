      ...
      <div className="d-flex justify-content-between align-items-start">
        <div className="flex-grow-1">
          ...
          {notification.department && (
            <small className="text-muted">Department: {notification.department}</small>
          )}
        ...
        <button
          ...
          aria-label={notification.isStarred ? 'Unstar notification' : 'Star notification'}
        >
          <i className={`bi ${notification.isStarred ? 'bi-star-fill' : 'bi-star'}`}></i>
        </button>
      </div>
      {!notification.isRead && (
