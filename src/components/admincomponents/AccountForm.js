...
const AccountForm = () => {
  ...
  if (loading) {
    return _jsxs("div", {
      ...
      children: [
        _jsx(Spinner, { animation: "border", variant: "success" }),
        _jsx("p", { className: "mt-3", children: "Loading account data..." }),
      ],
    });
  }
  ...
  return _jsxs(Form, {
    ...
    children: [
      _jsxs(Form.Group, {
        ...
        className: "mb-3",
        children: [
          _jsx(Form.Label, { children: "Full Name" }),
          _jsx(Form.Control, {
            type: "text",
            name: "fullName",
      ...
      _jsxs(Form.Group, {
        ...
        className: "mb-3",
        children: [
          _jsx(Form.Label, { children: "Email Address" }),
          _jsx(Form.Control, {
            type: "email",
            name: "email",
      ...
      _jsxs(Form.Group, {
        ...
        className: "mb-3",
        children: [
          _jsx(Form.Label, { children: "Phone Number" }),
          _jsx(Form.Control, {
            type: "tel",
            name: "phone",
      ...
      _jsxs(Form.Group, {
        ...
        className: "mb-3",
        children: [
          _jsx(Form.Label, { children: "Professional Bio" }),
          _jsx(Form.Control, {
            as: "textarea",
            rows: 3,
            name: "bio",
