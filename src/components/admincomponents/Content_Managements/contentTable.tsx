...
// import { contentMediaAPI, ContentItem } from '../../../services/contentService'; // Import API and types

// // Helper component: render icon or image based on content type
// const TypeIcon = ({ type, file_url }: { type: ContentItem['type'], file_url?: string }) => {
//     if (type === 'image' && file_url) {
//         const src = file_url.startsWith('/') ? `http://127.0.0.1:8000${file_url}` : file_url;
//         return (
//             <Image
//                 src={src}
//                 rounded
...
//             {status === 'published' && <CheckCircle2 size={12} style={{ marginRight: 4 }} />}
//             {status === 'processing' && <Clock size={12} style={{ marginRight: 4 }} />}
//             {labels[status]}
//         </span>
//     );
// };
...
//                 }}
//             >
//                 <h3 style={{ margin: 0, fontWeight: 600 }}>Content Library</h3>
...
//                                 {/* Category */}
//                                 <td style={{ fontSize: 14, color: '#6c757d' }}>{item.category || 'N/A'}</td>
...
//                                 {/* Date */}
//                                 <td style={{ fontSize: 14, color: '#6c757d' }}>{item.date}</td>

//                                 {/* Size */}
//                                 <td style={{ fontSize: 14, color: '#6c757d' }}>{item.size}</td>
