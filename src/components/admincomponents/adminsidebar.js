  ...
  return (
    ...
    _jsxs("div", {
      ...
      children: [
            ...
            children: [
              _jsx(Col, {
                ...
                children: _jsx("div", {
                  ...
                  children: _jsx(Icons.Shield, { size: 20, color: "#fff" }),
                }),
              }),
              _jsx(Col, {
                children: _jsx("h5", {
        ...
        _jsx(Nav, {
          className: "flex-column px-3 py-4",
            ...
            return _jsx(
              Nav.Item,
              {
                ...
                children: _jsxs(Button, {
                  ...
                  children: [
                    _jsx(IconComponent, { size: 18 }),
                    _jsx("span", { className: "small", children: item.label }),
                  ],
                }),
              },
              item.id,
        ...
        _jsxs("div", {
          ...
          children: [
            _jsxs(Button, {
              ...
              className:
                "w-100 d-flex align-items-center gap-3 mb-2 text-start",
              onClick: handleSettingsClick,
              children: [
                _jsx(Icons.Settings, { size: 18 }),
                _jsx("span", { className: "small", children: "Settings" }),
              ],
            }),
            _jsxs(Button, {
              variant: "outline-secondary",
              ...
              children: [
                _jsx(Icons.LogOut, { size: 18 }),
                _jsx("span", { className: "small", children: "Log Out" }),
              ],
            }),
          ],
        }),
