...
const Sidebar = () => {
    ...
    _jsxs("div", { style: {
            ...
            borderRight: '1px solid #dee2e6',
                ...
                }) }), _jsxs("div", { className: "px-3 py-3 border-top", children: [_jsxs(Button, { variant: "outline-secondary", className: "w-100 d-flex align-items-center gap-3 mb-2 text-start", children: [_jsx(Icons.Settings, { size: 18 }), _jsx("span", { className: "small", children: "Settings" })] }), _jsxs(Button, { variant: "outline-secondary", className: "w-100 d-flex align-items-center gap-3 text-start", children: [_jsx(Icons.LogOut, { size: 18 }), _jsx("span", { className: "small", children: "Log Out" })] })] })] }));
};
