...
export function AvailableReports({ reports, onDeleteReport }) {
    ...
    return (_jsx(Card, { className: "p-3", children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { className: "mb-4", style: { fontFamily: "heading" }, children: "Available Reports" }), _jsx(Stack, { gap: 3, children: reportsData.map((report) => (
