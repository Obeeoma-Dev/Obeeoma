...
export function AvailableReports() {
    ...
    return (_jsx(Card, { className: "p-3", children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { className: "mb-4", children: "Available Reports" }), _jsx(Stack, { gap: 3, children: reports.map((report, index) => (_jsxs("div", { style: {
                            display: "flex",
                            alignItems: "center",
                            padding: "1rem 0",
