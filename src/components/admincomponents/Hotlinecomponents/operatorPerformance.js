...
const OperatorPerformance = () => {
    return (_jsx(Card, { className: "h-100 operator-performance-card mb-4", children: _jsxs(Card.Body, { children: [_jsxs("div", { className: "mb-4", style: { fontFamily: "heading" }, children: [_jsx(Card.Title, { children: "Operator Performance" }), _jsx(Card.Subtitle, { className: "text-muted", style: { fontFamily: "body" }, children: "Daily resolution rates and call volume" })] }), operators.map((operator) => (_jsxs("div", { className: "mb-4", children: [_jsxs(Row, { className: "align-items-end mb-2", children: [_jsxs(Col, { children: [_jsx("div", { className: "fw-semibold", style: { fontFamily: "body" }, children: operator.name }), _jsxs("small", { className: "text-muted", style: { fontFamily: "body" }, children: [operator.performance, " calls today"] })] }), _jsxs(Col, { className: "text-end", children: [_jsxs("div", { className: `fw-bold ${operator.performance >= 90 ? "text-success" : "text-warning"}`, children: [operator.performance, "%"] }), _jsx("small", { className: "text-muted text-uppercase", style: { fontFamily: "body" }, children: "Resolution Rate" })] })] }), _jsx(ProgressBar, { now: operator.performance, variant: operator.performance >= 90 ? "success" : "warning", className: "operator-progress" })] }, operator.name)))] }) }));
};
