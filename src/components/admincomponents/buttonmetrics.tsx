        ...
        <section className="mb-4">
            ...
            <Row className="gy-4">
                ...
                {metrics.map((metric) => {
                    ...
                    const IconComponent =
                        (Icons[metric.icon as keyof typeof Icons] ?? Icons.Activity) as React.FC<{ size?: number; color?: string }>;
                        ...
                        <Col key={metric.id} xs={12} md={6} lg={3}>
                            ...
                            <Card className="shadow-sm border-0 h-100">
                                <Card.Body>
                                    ...
                                    <Button variant="link" className="p-0 text-success d-flex align-items-center gap-2">
