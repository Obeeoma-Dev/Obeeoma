...
const PatientSearchFilter = () => {
    ...
    return (_jsx(Form, { className: "mb-3", children: _jsxs(InputGroup, { children: [_jsx(Form.Control, { type: "text", placeholder: "Search patients by name or organization...", value: searchTerm, onChange: handleChange, "aria-label": "Search patients" }), _jsx(Button, { variant: "primary", onClick: handleSearch, children: "Search" })] }) }));
};
