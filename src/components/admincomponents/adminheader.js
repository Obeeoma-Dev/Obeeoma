    ...
    _jsx(Navbar, {
      ...
      children: _jsxs(Container, {
        ...
        children: [
          ...
          _jsxs(Row, {
            className: "align-items-center gx-4",
            children: [
              _jsx(Col, {
                xs: "auto",
                children: _jsxs(Button, {
                  ...
                  children: [
                    ...
                    _jsx(Badge, {
                      ...
                      pill: true,
                      className:
                        "position-absolute top-0 start-100 translate-middle text-white",
                      style: {
                        fontSize: "0.65rem",
                        width: "1.2rem",
                        height: "1.2rem",
                  ...
                  children: [
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("div", {
                          className: "fw-medium",
                          children: "Obeeoma System Admin",
                        }),
                      ],
                    }),
                    _jsx("div", {
                      className:
                        "bg-success rounded-circle d-flex align-items-center justify-content-center",
                      style: { width: "40px", height: "40px" },
                      children: _jsx(User, { size: 22, color: "#fff" }),
                    }),
                  ],
                }),
              }),
