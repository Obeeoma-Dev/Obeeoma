  ...
  return (
    ...
    <Navbar bg="white" className="border-bottom py-3">
      ...
      <Container fluid>
        ...
        <Form className="d-flex flex-grow-1 me-auto" style={{ maxWidth: '500px' }}>
        ...
        <Row className="align-items-center gx-4">
          ...
          <Col xs="auto">
            <Button variant="link" className="position-relative p-0 text-dark" aria-label="Notifications">
              <Bell size={22} />
              ...
              <Badge
                ...
                style={{ fontSize: '0.65rem', width: '1.2rem', height: '1.2rem' }}
              >
                2
              </Badge>
            </Button>
