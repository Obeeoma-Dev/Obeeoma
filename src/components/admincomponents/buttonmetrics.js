...
const BottomMetrics = ({ metrics }) => {
    ...
    _jsx("section", { className: "mb-4", children: _jsx(Row, { className: "gy-4", children: metrics.map((metric) => {
                ...
                _jsx(Col, { xs: 12, md: 6, lg: 3, children: _jsx(Card, { className: "shadow-sm border-0 h-100", children: _jsxs(Card.Body, { children: [_jsxs("div", { className: "d-flex align-items-start gap-3 mb-3", children: [_jsx("div", { className: "rounded p-2 d-flex align-items-center justify-content-center", style: { backgroundColor: '#e6f4ea', width: '40px', height: '40px' }, children: _jsx(IconComponent, { size: 20, color: iconColor }) }), _jsx("div", { children: _jsx("h6", { className: "text-muted mb-0", children: metric.title }) })] }), _jsx("h3", { className: "fw-bold mb-2", children: metric.value }), _jsx("p", { className: "text-muted small mb-3", children: metric.subtitle }), _jsxs(Button, { variant: "link", className: "p-0 text-success d-flex align-items-center gap-2", children: [_jsx("span", { children: metric.linkText }), _jsx(Icons.ArrowRight, { size: 16 })] })] }) }) }, metric.id));
            }) }) }));
};
