...
const BottomMetrics = ({ metrics }) => {
    ...
    _jsx("section", { className: "mb-4", children: _jsx(Row, { className: "gy-4", children: metrics.map((metric) => {
                ...
                _jsx(Col, { xs: 12, md: 6, lg: 3, children: _jsx(Card, { className: "shadow-sm border-0 h-100 hover-shadow", children: _jsxs(Card.Body, { children: [_jsxs("div", { className: "d-flex align-items-start gap-3 mb-3", children: [_jsx("div", { className: "rounded d-flex align-items-center justify-content-center", style: {
