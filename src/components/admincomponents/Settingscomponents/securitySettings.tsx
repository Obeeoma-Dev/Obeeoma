        ...
        <Card className="settings-card-compact shadow-sm border-0">
            ...
            <Card.Body>
                ...
                <div className="mb-4">
                    ...
                    <div className="p-3 border rounded-2 d-flex align-items-center justify-content-between" style={{ backgroundColor: '#f8f9fa' }}>
                ...
                <div className="mb-4">
                    ...
                    {/* Current Session */}
                    <div className="mb-3">
                        <div className="small text-muted mb-2 fw-semibold">CURRENT SESSION</div>
                    ...
                    {/* Previous Sessions */}
                    <div>
                        <div className="small text-muted mb-2 fw-semibold">PREVIOUS SESSIONS</div>
                        <div className="p-3 border rounded-2 d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center">
                                <div
                                    style={{
