...
const PlatformUsageChart = ({ platformData = [], subscriptionData = [], }) => {
    ...
    return (_jsx(Card, { className: "mb-4 shadow-sm border-0", children: _jsxs(Card.Body, { children: [_jsx(ButtonGroup, { className: "mb-4 w-100 justify-content-between", children: tabs.map((tab) => (_jsx(Button, { variant: "light", onClick: () => setActiveTab(tab.id), "aria-pressed": activeTab === tab.id, className: `px-3 py-2 border-0 position-relative ${activeTab === tab.id
                            ...
                            fontFamily: "heading",
                        }, children: tab.label }, tab.id))) }), _jsxs("h5", { className: "fw-semibold text-dark mb-4 md-4 position-relative ms-5", style: { fontFamily: "body" }, children: [activeTab === "platform" && "Weekly Platform Usage", activeTab === "organization" && "Monthly Organization Growth", activeTab === "subscription" && "Monthly Subscription Revenue"] }), activeTab === "platform" && (_jsx(ResponsiveContainer, { width: "100%", height: 300, style: { fontFamily: "body" }, children: employeeData.length > 0 ? (_jsxs(AreaChart, { data: employeeData, margin: { top: 20, right: 30, left: 0, bottom: 0 }, children: [_jsx(CartesianGrid, { stroke: "#dee2e6", strokeDasharray: "0", vertical: false }), _jsx(XAxis, { dataKey: "week", tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(Tooltip, { contentStyle: {
                                    ...
                                    strokeWidth: 1,
                                    fill: "#ffffff",
                                }, activeDot: { r: 5 } })] })) : (_jsx("div", { className: "d-flex justify-content-center align-items-center h-100 text-muted", children: _jsxs("div", { className: "text-center", children: [_jsx("p", { children: "No platform usage data available" }), _jsx("small", { children: "Data will appear here once users start using the platform" })] }) })) })), activeTab === "organization" && (_jsx(ResponsiveContainer, { width: "100%", height: 300, style: { fontFamily: "body" }, children: employeeData.length > 0 ? (_jsxs(LineChart, { data: employeeData, margin: { top: 20, right: 30, left: 0, bottom: 0 }, children: [_jsx(CartesianGrid, { stroke: "#dee2e6", strokeDasharray: "0", vertical: false }), _jsx(XAxis, { dataKey: "week", tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(Tooltip, { contentStyle: {
                                    backgroundColor: "#ffffff",
                                    border: "1px solid #dee2e6",
                                    fontSize: "0.875rem",
                                    color: "#212529",
                                    ...
                                    strokeWidth: 1,
                                    fill: "#ffffff",
                                }, activeDot: { r: 5 } })] })) : (_jsx("div", { className: "d-flex justify-content-center align-items-center h-100 text-muted", children: _jsxs("div", { className: "text-center", children: [_jsx("p", { children: "No organization growth data available" }), _jsx("small", { children: "Data will appear here once organizations start joining" })] }) })) })), activeTab === "subscription" && (_jsx(ResponsiveContainer, { width: "100%", height: 300, children: revenueData.length > 0 ? (_jsxs(AreaChart, { data: revenueData, margin: { top: 20, right: 30, left: 0, bottom: 0 }, children: [_jsx(CartesianGrid, { stroke: "#dee2e6", strokeDasharray: "0", vertical: false }), _jsx(XAxis, { dataKey: "week", tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(YAxis, { tick: { fontSize: 12, fill: "#6c757d" }, axisLine: false, tickLine: false }), _jsx(Tooltip, { contentStyle: {
                                    backgroundColor: "#ffffff",
                                    border: "1px solid #dee2e6",
                                    fontSize: "0.875rem",
                                    color: "#212529",
