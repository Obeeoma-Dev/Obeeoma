...
const Footer = () => {
    ...
    return (_jsx("footer", { className: "py-5", style: { backgroundColor: '#0B6E45' }, "data-testid": "footer", children: _jsxs("div", { className: "container", children: [_jsx("div", { className: "row mb-4", children: _jsx("div", { className: "col-12", children: _jsx("img", { src: Obeeoma, alt: "Obeeoma", className: "mb-2", style: {
                                height: "40px",
                                width: "auto",
