  ...
  const benefits = [
    {
      ...
      description:
        "Built for Africa's young, digital-savvy workforce with cutting-edge technology",
    ...
    },
    {
      ...
      description:
        "Flexible subscription models for organizations of all sizes",
            ...
            <Row className="gy-4 gx-4">
              ...
              {benefits.map((benefit, index) => (
                <Col key={index} lg={6} md={6} sm={12}>
                  ...
                  <div
                    className="benefit-card p-5 h-100 d-flex flex-column justify-content-start"
                    style={
                      {
                  ...
                  >
                    ...
                    <div className="icon-box mb-4">{benefit.icon}</div>

                    {/* Text content: title and description */}
                    <div>
                      <h5
                        className="fw-bold text-dark mb-2"
                        style={{ fontFamily: "heading", fontSize: "22px" }}
                      >
                        {benefit.title}
                      </h5>
                      {benefit.description && (
                        <p
                          ...
                          style={{ fontFamily: "body", fontSize: "16px" }}
                        >
                          {benefit.description}
                        </p>
                      )}
