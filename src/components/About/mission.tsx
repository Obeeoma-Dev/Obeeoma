                ...
                <Row className="align-items-center mb-5">
                        ...
                        <Row className="text-center" style={{ marginTop: "2rem" }}>
                            <Col xs={12} md={3} className="mb-4">
                                <Card style={{ border: "none", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
                                    <Card.Body>
                                        <FaUsers size={32} style={{ color: "#0B6E45", marginBottom: "0.5rem" }} />
                                        <h5 style={{ fontWeight: "bold", color: "#0B6E45" }}>500+</h5>
                            ...
                            <Col xs={12} md={3} className="mb-4">
                                <Card style={{ border: "none", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
                                    <Card.Body>
                                        <FaClock size={32} style={{ color: "#0B6E45", marginBottom: "0.5rem" }} />
                                        <h5 style={{ fontWeight: "bold", color: "#0B6E45" }}>15+</h5>
                    ...
                    <Col md={6} style={{ position: "relative" }}>
                        ...
                        >
                            ...
                            <Card.Body>
                                <FaSmile size={32} style={{ color: "#0B6E45", marginBottom: "0.5rem" }} />
                                <h3 style={{ fontSize: "2rem", fontWeight: "bold", color: "#0B6E45" }}>98%</h3>
