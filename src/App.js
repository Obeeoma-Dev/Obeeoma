...
export default function App() {
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsxs(TooltipProvider, { children: [_jsx(Toaster, {}), _jsx(BrowserRouter, { children: _jsx(Provider, { store: store, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Navigate, { to: "/index", replace: true }) }), _jsx(Route, { path: "/index", element: _jsx(Index, {}) }), _jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/signup", element: _jsx(CreateAccount, {}) }), _jsx(Route, { path: "/reset-password", element: _jsx(ResetPassword, {}) }), _jsx(Route, { path: "/reset-password-signin", element: _jsx(ResetPasswordSignin, {}) }), _jsx(Route, { path: "/accept-invite", element: _jsx(AcceptInvite, {}) }), _jsx(Route, { path: "/employee-dashboard", element: _jsx(EmployeeDashboard, {}) }), _jsx(Route, { path: "/organization-reports", element: _jsx(CompanyReports, {}) }), _jsx(Route, { path: "/employer-dashboard", element: _jsx(EmployerDashboard, {}) }), _jsx(Route, { path: "/employer-subscription", element: _jsx(EmployerSubscription, {}) }), _jsx(Route, { path: "/employee-management", element: _jsx(EmployeeManagement, {}) }), _jsx(Route, { path: "/employer-profile", element: _jsx(EmployerAccountProfile, {}) }), _jsx(Route, { path: "/employer-notifications", element: _jsx(EmployerNotificationPage, {}) }), _jsx(Route, { path: "/employer-settings", element: _jsx(EmployerAccountSettingsPage, {}) }), _jsx(Route, { path: "/system-admin/organizations", element: _jsx(Organisation, {}) }), _jsx(Route, { path: "/systemadmin/organizations/:id", element: _jsx(OrganisationDetails, {}) }), _jsx(Route, { path: "/system-admin/client-engagement", element: _jsx(ClientEngagement, {}) }), _jsx(Route, { path: "/system-admin/ai-management", element: _jsx(AIRecommendationsPage, {}) }), _jsx(Route, { path: "/system-admin/hotline-activity", element: _jsx(HotlineActivity, {}) }), _jsx(Route, { path: "/system-admin/Subscriptions", element: _jsx(SubscriptionPage, {}) }), _jsx(Route, { path: "/system-admin/reports", element: _jsx(ReportPage, {}) }), _jsx(Route, { path: "/system-admin", element: _jsx(SysAdminDashboard, {}) }), _jsx(Route, { path: "/system-admin/settings-overview", element: _jsx(AdminSettings, {}) }), _jsx(Route, { path: "/system-admin/organizations", element: _jsx(Organisation, {}) }), _jsx(Route, { path: "/systemadmin/organizations/:id", element: _jsx(OrganisationDetails, {}) }), _jsx(Route, { path: "/system-admin/client-engagement", element: _jsx(ClientEngagement, {}) }), _jsx(Route, { path: "/system-admin/ai-management", element: _jsx(AIRecommendationsPage, {}) }), _jsx(Route, { path: "/system-admin/hotline-activity", element: _jsx(HotlineActivity, {}) }), _jsx(Route, { path: "/system-admin/Subscriptions", element: _jsx(SubscriptionPage, {}) }), _jsx(Route, { path: "/system-admin/reports", element: _jsx(ReportPage, {}) }), _jsx(Route, { path: "/system-admin", element: _jsx(SysAdminDashboard, {}) }), _jsx(Route, { path: "/system-admin/settings-overview", element: _jsx(AdminSettings, {}) }), _jsx(Route, { path: "/settings-overview/subscription-editor", element: _jsx(SubscriptionEditor, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFound, {}) })] }) }) })] }) }));
}
