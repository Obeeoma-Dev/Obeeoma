          ...
          {activities.map((activity, index) => {
            ...
            return (
              <React.Fragment key={activity.id}>
                {/* Activity row */}
                <div className="py-3 px-2 d-flex justify-content-between align-items-center" style={{ borderRadius: '8px', transition: 'background-color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f8f9fa'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                ...
                {index < activities.length - 1 && (
                  <div className="border-bottom" style={{ borderColor: '#e9ecef' }}></div>
                )}
              </React.Fragment>
            );
          })}
