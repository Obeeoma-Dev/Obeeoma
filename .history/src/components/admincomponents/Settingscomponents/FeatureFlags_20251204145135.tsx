...
const FeatureFlags: React.FC = () => {
  ...
  return (
    <Card className="p-4 shadow-sm border-0">
      <Card.Header className="fw-semibold mb-4 bg-transparent border-0 ps-0 pb-3">Feature Flags</Card.Header>
          ...
          <Row className="g-3">
            ...
            {flags.map((flag) => (
              <Col md={6} lg={5} key={flag.id}>
                <div className="p-3 border rounded-2 bg-light-hover transition">
                  <Form.Check
