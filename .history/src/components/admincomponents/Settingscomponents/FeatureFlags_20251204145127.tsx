...
const FeatureFlags: React.FC = () => {
  ...
  return (
    <div>
      {/* Section heading */}
      <h4 className="mb-4 fw-semibold md-4">Feature Flags</h4>
      ...
      <Form>
        <Container>
          <Row className="justify-content-center">
            ...
            {flags.map((flag) => (
              <Col md={6} lg={5} key={flag.id} className="mb-4">
                <Form.Check
                  ...
                  className={flag.enabled ? "text-success" : "text-muted"} // Color feedback
                />
              </Col>
            ))}
          </Row>
