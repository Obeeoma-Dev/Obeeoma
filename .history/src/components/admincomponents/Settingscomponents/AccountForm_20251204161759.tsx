  ...
  return (
    <Card className="settings-card-compact shadow-sm border-0">
      ...
      <Form onSubmit={handleSubmit}>
        {/* Top profile summary (avatar, name, role, change photo) */}
        <div className="d-flex align-items-center justify-content-between mb-3 p-2 bg-white rounded-3" style={{boxShadow: '0 1px 4px rgba(16,24,40,0.04)'}}>
          <div className="d-flex align-items-center">
            ...
            <div className="ms-3">
              <div className="fw-bold" style={{fontSize: '0.98rem'}}>Dr. Sarah Johnson</div>
