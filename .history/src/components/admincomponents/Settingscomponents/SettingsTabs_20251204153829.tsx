  ...
  return (
    <div className="p-4">
      ...
      <Tabs
        ...
        className="settings-nav mb-4 border-bottom" // Bottom margin for spacing and custom styles
      >
        ...
        <Tab eventKey="notifications" title="Notifications" className="mt-4">
          <NotificationSettings />
        </Tab>

        {/* Tab for Appearance customization */}
        <Tab eventKey="appearance" title="Appearance" className="mt-4">
          <AppearenceSettings />
        </Tab>

        {/* Tab for Subscription details */}
        <Tab eventKey="subscription" title="Subscription" className="mt-4">
          <SubscriptionSettingsComp plans={subscriptionPlans} />
        </Tab>

        {/* Tab for Feature flags */}
        <Tab eventKey="feature-flags" title="Feature Flags" className="mt-4">
          <FeatureFlags />
        </Tab>
      </Tabs>
    </div>
