    ...
    <div className="min-vh-100 d-flex flex-column justify-content-between bg-light">
      ...
      <header className="d-flex justify-content-between align-items-center p-3 px-4 border-bottom bg-white">
        <div className="d-flex align-items-center">
          <img src="/assets/Images/obeeomalogoicon4.png" alt="/assets/Images/obeeomalogoicon4.png" width="35" className="me-2" />
          <div>
          ...
          <Card.Body>
            ...
            <Form>
              ...
              <p className="mt-3 text-center text-muted">
                          ...
                          <Link to="/Regist" className="text-success fw-semibold">
                            Create an account
                          </Link>
                        </p>
              </div>
