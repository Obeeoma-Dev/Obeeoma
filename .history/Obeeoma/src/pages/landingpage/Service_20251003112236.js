          ...
          children: [
            _jsx("div", {
              ...
              children: services.map((service, index) =>
                _jsx(
                  ...
                  {
                    className:
                      "hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20",
            ...
            _jsxs("div", {
              ...
              children: [
                _jsx("div", {
                  className:
                    "absolute inset-0 bg-primary/5 rounded-3xl -z-10 transform translate-x-8 translate-y-8",
                }),
                _jsx("img", {
                  src: image3,
